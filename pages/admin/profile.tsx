import LayoutAdminProfile from "@/components/Layout/admin/profile";
...
const AdminProfile: NextPage<Props> = ({ dirs }) => {
  ...
  const handleUpload = async () => {
    ...
    setTimeout(async () => {
      ...
      const upload = await dispatch(doUpdatePhotoUsers(userId, isDataUpload));
      await dispatch(doUserRequest(userId));
      await localStorage.setItem('profilePhotoMe', isDataUpload.usproPhoto);
      await ComponentsIndicatorToast({ status: 'success', message: 'Data uploaded successfully' });
    }, 1000);
  };
  ...
  if (profile&&profileBP&&profileMemb) {
      return (
        <div>
          <Head>
            <title>Profile</title>
          ...
          <LayoutAdminProfile>
            <Box pl={2} pr={2}>
              <Box className="w-full" pt={9} pb={0}  >
                <Box p={4} className="w-full border rounded-lg bg-white pb-6">
                  <Box className="flex justify-between">
                    <Box className="w-3/5">
                      <Box className=" mb-4 font-bold w-full h-fit mx-auto items-center text-blue-900 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75">
                        <div className={styles.textTitleInProfile}>
                        General
                        </div>
                      </Box>
                      <hr className="h-1 bg-[#7FA3FF]"/>
                      <Box className="pt-4 text-left font-normal text-blue-900">
                        <div className={styles.textLabelInProfile}>
                          This information will be displayed, so be careful what you share
                        </div>
                      </Box>
                      <Box className="pt-4 pb-4 flex justify-between">
                        <Box className="w-1/4">
                          ...
                          {selectedImage&&selectPhoto ? (
                            <Box className="flex justify-center">
                              <button
                                className="shadow-lg w-32 py-1 px-1 mx-auto rounded-md  bg-blue-100 text-center text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75"
                        ...
                        <Box className="w-2/3">
                          <Box className="grid">
                                    ...
                                    <span>
                                      {
                                        profile ? profile.user_email
                                          : ""
                                      } <label className="font-normal text-blue-900"><em>(default)</em></label>
                                    </span>
                                  ) : (
                                ...
                                <span className={styles.formProfile}>
                                  {
                                    profile.user_phone_number ? (
                                      <span>
                                        {profile.user_phone_number} <label className="font-normal text-blue-900"><em>(active)</em></label>
                                      </span>
                                    ) : (
                            ...
                            <Box className="grid place-content-end w-full pr-12">
                              <div className={styles.PTbuttonEditProfile}>
                                  <button
                                    className="shadow-lg w-32 py-1 px-0  mx-auto rounded-md  bg-blue-100 text-center text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75"
                                    onClick={() => handleEdit()}
                                  >
                    ...
                    <Box className="w-2/5">
                      ...
                      <hr className="h-1 bg-[#BDD0FF]"/>
                      <Box className="pt-4 ">
                        <Box className="w-full pb-4">
                          <Box className="flex items-stretch">
                            <div className="text-left font-normal text-blue-900">
                              <div className={styles.textLabelInProfile}>
                                Change password 
                              </div>
                            </div>
                        ...
                        <Box className="flex justify-between">
                          ...
                          <Box className="w-full pl-4">
                              <button
                                className="shadow-lg w-full py-1 px-1 mx-auto rounded-md  bg-blue-100 text-center text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75"
                ...
                <div className="flex min-h-full items-center justify-center p-4 text-center">
                  ...
                  >
                    <Dialog.Panel className="grid transform max-h-96 overflow-y-auto rounded-xl bg-white text-left  shadow-xl transition-all">
                      <Dialog.Title
                        as="h3"
                        className="pl-8 pr-8 sticky top-0 flex justify-between font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-blue-900 text-blue-100 hover:bg-blue-800 focus:outline-none focus-visible:ring focus-visible:ring-opacity-75"
                      >
                      ...
                      <Dialog.Title
                        as="h3"
                        className="pl-8 mb-8 font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-blue-100 text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75"
                      >
                        <div className={styles.textTitleInProfileEdit}>
                          General
                        </div>
                        ...
                        {({
                          ...
                          <Form onSubmit={handleSubmit}>
                            ...
                            >
                              ...
                              {/* UserType */}
                              <FormControl color="primary" size="small" variant="standard"  sx={{ gridColumn: "span 4" }} error={!!touched.userType && !!errors.userType}>
                              ...
                              {/* usroRole */}
                              <FormControl size="small" color="primary" variant="standard" sx={{ gridColumn: "span 4" }} error={!!touched.usroRole && !!errors.usroRole}>
                              ...
                              >
                                  ...
                                  <MenuItem value={5}>Staff</MenuItem>
                              </Select>
                            ...
                            >
                              ...
                              {/* usproGender */}
                              <FormControl color="primary" size="small" variant="standard" sx={{ gridColumn: "span 4" }}>
