...
import { Box, Button, FormControl, IconButton, InputAdornment, InputLabel, MenuItem, Select, Tooltip, Typography } from "@mui/material"
...
const ProfileOld: NextPage<Props> = ({ dirs }) => {
