  ...
  return (
    <>
      ...
      <Layouts>
        ...
        <div className=''>
          <div id="hotels" className=' bottom-0 mt-0 justify-center text-center font-bold text-2xl'>
            <h1 className={styles.textTitleInHome}>Best Hotels 2023</h1>
            <div className='flex justify-center mt-6'>
              <CardHotel/>
            </div>
          </div>
          <div id="facility" className='text-center'>
            <div className='font-bold text-2xl  mt-12 mb-6 text-center'>
              <h1 className={styles.textTitleInHome}>Facility Our Hotels</h1>
            </div>
            <div className='h-80' style={{background:'rgba(243, 60, 93, 0.09)'}}>
          ...
          <div id="about" className="pr-12 pl-12">
            ...
            <div className='h-56 px-0 py-6 mb-16 text-justify'>
