...
import LayoutManagerProfile from "@/components/Layout/manager/profile";
...
const ManagerProfile: NextPage<Props> = ({ dirs }) => {
  ...
  if (profile&&profileBP&&profileMemb) {
      return (
        <div>
          ...
          <LayoutManagerProfile>
            <Box pl={2} pr={2}>
              <Box className="w-full" pt={8} pb={0}  >
