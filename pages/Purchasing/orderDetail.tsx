...
const orderDetail = () => {
  ...
  const detailColumn: ColumnsType<orderDetail> = [
    ...
    { title: "", dataIndex: "", key: "x", render: () => <p onClick={showModal1} className="hover:underline hover:text-blue-500 cursor-pointer">Edit</p> },
  ];
  const dataDetail: orderDetail[] = [
    {
      podePoheId: 1,
      podeOrderQty: 100,
      podePrice: 1000000,
      podeLineTotal: 1500000000,
      podeReceivedQty: 500,
      podeRejectedQty: 200,
      podeStockedQty: 300,
      podeStockId: 2,
  ...
  return (
    <div className="m-8">
      ...
      <Modal title='Edit Order Detail' open={openModal1} onCancel={closeModal1} footer={[
