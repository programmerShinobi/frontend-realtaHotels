import LayoutGuestProfile from "@/components/Layout/guest/profile";
...
import { InputRef, Tabs, Tag, Button, Input, Space, Table, InputNumber } from "antd";
...
const GuestProfile: NextPage<Props> = ({ dirs }) => {
                  ...
                  <div className="flex min-h-full items-center justify-center p-4 text-center">
                    ...
                    >
                      <Dialog.Panel className="grid transform max-h-96 overflow-y-auto rounded-xl bg-white text-left  shadow-xl transition-all">
                        <Dialog.Title
                          as="h3"
                          className="pl-8 pr-8 sticky top-0 flex justify-between font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-pink-900 text-pink-100 hover:bg-pink-800 focus:outline-none focus-visible:ring focus-visible:ring-opacity-75"
                        >
                          ...
                          <button
                            ...
                            type="button"
                            className="rounded-md font-bold shadow-md h-fit py-1 px-1  items-end bg-[#FFDFE5] text-pink-900 hover:bg-[#FFACBB] focus:outline-none focus-visible:ring focus-visible:ring-pink-500 focus-visible:ring-opacity-75">
                            <XMarkIcon width={20} height={20} />
                          </button>
                        </Dialog.Title>
                        <Dialog.Title
                          as="h3"
                          className="pl-8 mb-8 font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-[#FFDFE5] text-pink-900 hover:bg-[#FFACBB] focus:outline-none focus-visible:ring focus-visible:ring-pink-500 focus-visible:ring-opacity-75"
                        >
                          <div className={styles.textTitleInProfileEdit}>
                            General
                          </div>
                          ...
                          {({
                            ...
                            <Form onSubmit={handleSubmit}>
                              ...
                              >
                                ...
                                {/* UserType */}
                                <FormControl color="secondary" size="small" variant="standard"  sx={{ gridColumn: "span 4" }} error={!!touched.userType && !!errors.userType}>
                                ...
                                {/* usroRole */}
                                <FormControl size="small" color="secondary" variant="standard" sx={{ gridColumn: "span 4" }} error={!!touched.usroRole && !!errors.usroRole}>
                              ...
                              >
                                ...
                                {/* usproGender */}
                                <FormControl color="secondary" size="small" variant="standard" sx={{ gridColumn: "span 4" }}>
                              ...
                              <Box className="flex flex-row-reverse pb-8">
                                <Box className='pr-8'>
                                  <button
                                    type="submit"
                                    className="rounded-md font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-[#FFDFE5] text-pink-900 hover:bg-[#FFACBB] focus:outline-none focus-visible:ring focus-visible:ring-pink-500 focus-visible:ring-opacity-75">
