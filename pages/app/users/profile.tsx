...
import ComponentsLayoutAppUsersAdminProfile from "@/components/Layout/app/users/admin/profile";
import ComponentsLayoutAppUsersGuestProfile from "@/components/Layout/app/users/guest/profile";
import ComponentsLayoutAppUsersManagerProfile from "@/components/Layout/app/users/manager/profile";
import ComponentsLayoutAppUsersOBProfile from "@/components/Layout/app/users/ob/profile";
import ComponentsLayoutAppUsersStaffProfile from "@/components/Layout/app/users/staff/profile";
...
const PagesAppUsersProfile: NextPage<Props> = ({ dirs }) => {
  ...
  const handleUpload = async () => {
    ...
    setTimeout(async () => {
      ...
      await ComponentsIndicatorToast({ status: 'success', message: 'You have successfully profile photo updated' });
    }, 1000);
  };
  ...
  const handleFormSubmitEdit = (values: any, { setSubmitting }: any) => {
    ...
    setTimeout(() => {
      setIsOpenEdit(false);
      dispatch(doUserRequest(userId));
      ComponentsIndicatorToast({status: 'success', message: 'You have successfully general updated'});
  ...
  const handleFormSubmitEditPassword = (values: any, { setSubmitting }: any) => {
    ...
    setTimeout(() => {
      setIsOpenEditPassword(false);
      dispatch(doUserRequest(userId));
      ComponentsIndicatorToast({status: 'success', message: 'You have successfully security updated'});
    }, 500);
    setSubmitting(false);
  };
    ...
    if (role == 4) {
      return (
        <>
          ...
          <ComponentsLayoutAppUsersAdminProfile>
            <Box className="grid shadow-md rounded-xl bg-white pb-8">
              {/* General */}
              <Box className="m-8 pl-8 font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-orange-100 text-orange-900 hover:bg-orange-200 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-75">
                <Typography className={styles.textTitleInProfile}>
...
=======
                            ...
                            <span>
                              {
                                profile ? profile.user_email
                                  : ""
                              } <label className="font-normal text-orange-900"><em>(default)</em></label>
                            </span>
                          ) : (
                            <em className="text-gray-300">{"Email (None)"}</em>
                          )}
      ...
      return (
        <>
          ...
          <ComponentsLayoutAppUsersGuestProfile>
            <Box className="grid shadow-md rounded-xl bg-white pb-8">
              {/* General */}
              <Box className="m-8 pl-8 font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-orange-100 text-orange-900 hover:bg-orange-200 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-75">
                <Typography className={styles.textTitleInProfile}>
...
=======
      ...
      return (
        <>
          ...
          <ComponentsLayoutAppUsersManagerProfile>
            <Box className="grid shadow-md rounded-xl bg-white pb-8">
              {/* General */}
              <Box className="m-8 pl-8 font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-orange-100 text-orange-900 hover:bg-orange-200 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-75">
                <Typography className={styles.textTitleInProfile}>
      ...
      return (
        <>
          ...
          <ComponentsLayoutAppUsersOBProfile>
            <Box className="grid shadow-md rounded-xl bg-white pb-8">
              {/* General */}
              <Box className="m-8 pl-8 font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-orange-100 text-orange-900 hover:bg-orange-200 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-75">
                <Typography className={styles.textTitleInProfile}>
      ...
      return (
        <>
          ...
          <ComponentsLayoutAppUsersStaffProfile>
            <Box className="grid shadow-md rounded-xl bg-white pb-8">
              {/* General */}
              <Box className="m-8 pl-8 font-bold shadow-md w-full h-fit py-2 px-2 mx-auto items-center bg-orange-100 text-orange-900 hover:bg-orange-200 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-75">
                <Typography className={styles.textTitleInProfile}>
...
export default PagesAppUsersProfile;