...
function* handleUpdateRegions(action: any){
    try {
        ...
        console.log('update saga regions :', action.payload)
...
function* handleUpdatePolicy(action: any) {
    console.log(action,'dPolicyUpdate')
    try {
         yield call(ReduceService.update5, action.payload);
        console.log('updateYield:',action.payload)
...
function* handleAddCagro(action: any) {
