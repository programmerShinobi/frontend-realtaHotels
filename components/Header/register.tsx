...
export default function HeaderRegister({ showNav, setShowNav }: any) {
    ...
    <div>
      ...
      <div className="static w-full h-8 pt-2 justify-center ">
        <div className="flex flex-row">
          ...
          <div className=" w-auto">
            <Link href="./registerGuest">
              <div
                className={`text-left text-sm font-medium cursor-pointer flex items-left transition-colors ${router.pathname == "/users/registerGuest"
                  ? " text-orange-500"
                  : "text-orange-900 hover:text-orange-500"
                  }`}
              >
