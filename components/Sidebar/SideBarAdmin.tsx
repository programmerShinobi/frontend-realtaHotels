              ...
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin">
                      <div
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="#">
                      <div
            ...
            <Disclosure>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin/master">
                      <div
            ...
            <Disclosure>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin/hr">
                      <div
            ...
            <Disclosure>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin/users">
                      <div
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin/users/roles">
                      <div
            ...
            <Disclosure>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin/booking">
                      <div
            ...
            <Disclosure>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin/hotels">
                      <div
            ...
            <Disclosure>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin/resto">
                      <div
            ...
            <Disclosure>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin/payment">
                      <div
            ...
            <Disclosure>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pt-2 w-full">
                    <Link prefetch={true} suppressHydrationWarning={true} href="/admin/purchasing">
                      <div
